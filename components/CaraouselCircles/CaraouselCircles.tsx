    ...
    for (let i = 0; i < length; i++) {
      if (i === active) {
        if (variant === "secondary") {
          circleIcons.push(
            <CircleFilled key={i} width={8} height={8} color="#FFCC00" />
          );
          ...
          circleIcons.push(
            <CircleFilled key={i} width={12} height={12} color="white" />
          );
        }
      } else {
        if (variant === "secondary") {
          circleIcons.push(
            <CircleFilled key={i} width={8} height={8} color="#d9d9d9" />
          );
        } else if (variant === "tertiary") {
          circleIcons.push(
            <CircleFilled key={i} width={8} height={8} color="#000000" />
          );
        } else {
          circleIcons.push(
            <Circle key={i} width={12} height={12} color="white" />
          );
        }
      }
    }
